...
<template>
  <section>
    <div style="margin-top: 90px;" >
          <form class="row g-2">
        <div style="max-width: 22rem; margin-right: 20px; " class="card mb-3"  v-for="(item,index) in Listdata" :key="index">
        <div class="row g-0">
          <div class="col-md-auto">
          <img style="margin-top: 15px; margin-left: 14px;" :src="item.profile_image_url " :width="size" :height="size" class=" rounded">
          </div>
          <div class="col-md-9">
            <div class="card-body">
              <h5 class="card-title"><p>{{item.name}}</p></h5>
              <p style="font-size: 12px;" class="card-text" type="hidden" ><img src="https://cdn.iconscout.com/icon/free/png-128/date-1779326-1512602.png" :width="minisize" :height="minisize" style="margin-bottom: 7px;"> 10:00 AM - 6:00 PM <a style="margin-left: 70px; color: #134B8A;" class="text-end" aria-readonly="">
                <img src="https://cdn-icons-png.flaticon.com/512/4674/4674263.png" :width="minisize" :height="minisize" style="margin-bottom: 3px;"> {{item.rating}}</a></p>
